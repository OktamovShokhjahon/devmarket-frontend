                ...
                <CardContent className="space-y-4">
                  <div className="grid gap-4 sm:grid-cols-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="last-name" placeholder="Doe" defaultValue={user.name?.split(" ")[1] || ""} required />
                    </div>
                  </div>
                  <div className="space-y-2">
                    ...
                    {walletBalance > 0 && (
                      <div className="mt-4 rounded-md border p-4">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="text-sm font-medium">Available: {formatPrice(walletBalance)}</div>
                        </div>
                      </div>
                    )}
                  </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between font-medium">
                  <span>Total</span>
                  <span>{useWallet ? formatPrice(Math.max(0, total - walletBalance)) : formatPrice(total)}</span>
                </div>
              </div>
            </CardContent>
          </Card>
